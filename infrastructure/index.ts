...
// Load the configuration settings for the current stack.
...
// Clean the registry name to match the required pattern (alphanumeric only)
const cleanRegistryName = `${prefixName.replace(/[^a-zA-Z0-9]/g, '')}ACR`
